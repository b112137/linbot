...
machine = TocMachine(states=["user",
        ...
        transitions=[
            ...
            {
                "trigger": "advance",
                "source": ["feature", "wanteat", "breakfast", "lunch", "dinner", "midnight", "arrange_store", "arrange_type", "add_store", "add_condition", "delete_store", "search_store", "feedback"],
                "dest": "feature",
                "conditions": "is_going_to_feature",
            },
            {
            ...
            },
            {
                ...
                "source": "feature",
                "dest": "feedback",
                "conditions": "is_going_to_feedback",
            },
            {
                "trigger": "advance",
                "source": "feedback",
                "dest": "feedback_condition",
